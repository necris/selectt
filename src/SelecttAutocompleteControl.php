...
class SelecttAutocompleteControl extends Control
{
    ...
    public function handleAutocomplete(): void
    {
        ...
        $offsetStart = ($page - 1) * $this->getResultsPerPage();
        $offsetEnd = $offsetStart + $this->getResultsPerPage();
        ...
        $results = $this->getDataSource()->searchTerm($query, $this->getResultsPerPage(), $offsetStart);
    ...
    public function setResultsPerPage(int $resultsPerPage): SelecttAutocompleteControl
    {
